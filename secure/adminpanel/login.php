...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        $sql = "SELECT id, username, password FROM admincredentials WHERE username = ?";
...
<html>
	<head>
    <meta charset="UTF-8">
        <title>Login Page Admin | Admin Makmur Barokah</title>
        <link rel="shortcut icon" href="img/files/favicon.png" type="image/png">
    ...
    <body background="img/files/bg.jpg">
        ...
        <div class="custom container-fluid d-flex align-items-center justify-content-center">
            <div class="row bg-light form">
                <div class="col mt-3 col-xs-12 col-md-12 col-lg-12">
                    ...
                    <h1 style="text-align:center">Login Page Admin</h1><br>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate class="needs-validation">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control orange-border <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>">
                            <span class="invalid-feedback"><?php echo $password_err; ?></span>
                        </div>
                        <div class="form-group">
                            <input type="submit" class="btn btn-block btn-orange" value="Masuk">
                        </div>
                    </form>
                </div>
